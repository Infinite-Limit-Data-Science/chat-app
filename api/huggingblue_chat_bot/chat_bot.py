...
class ChatBot(RunnableSerializable[I, O]):
    ...
    graph: Optional[CompiledStateGraph] = Field(default=None, exclude=True)

    chat_model: BaseChatModel = None
    retry_model: BaseChatModel = None
    ...
    def invoke(
        ...
        **kwargs: Any,
        ...
        return self.graph.invoke({'messages': input.messages})
    ...
    #     self.graph.add_edge('guardrails', END)
    #     return self.graph.compile()
        ...
        #     {
        #         "vectorstore": "vectors      self.graph.add_node('vectorstore', vectorstore_node)
        ...
        # self.graph.add_edge('dataframe_analysis', evalaute_tool_response)tore",
