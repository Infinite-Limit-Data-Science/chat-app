...
# LangGraph is a graph-based execution framework built on top of LangChain. Unlike traditional LangChain agents, LangGraph agents do not rely on a single monolithic prompt with agent_scratchpad. Instead, state is managed explicitly using a graph structure.
...
# Example Selectors to use: Similarity Selector and N-gram Overlap Selector
