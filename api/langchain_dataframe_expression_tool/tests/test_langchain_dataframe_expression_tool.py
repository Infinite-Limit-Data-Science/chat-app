...
def chat_model() -> BaseChatModel:
    model_details = {"name":"meta-llama/Meta-Llama-3.1-70B-Instruct","endpoints":[{"url":"http://3.210.60.7:8080/","type":"tgi"}],"classification":"text-generation","active": True}
...
def test_few_shot_prompt(function_call_schema: QueryDataFrame, chat_model: BaseChatModel, chat_history: List[BaseMessage]):
    ...
    chat_prompt.format_messages(chat_history=chat_history)
