...
class SymmetricIdp(Idp):
    ...
    secret: str = Field(description='Shared secret for symmetric algorithm', min_length=8)
...
class AsymmetricIdp(Idp):
    ...
    public_key_url: Optional[HttpUrl] = Field(description='URL to fetch JWKS if key_source is url', default=None)
